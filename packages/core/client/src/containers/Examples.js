...
const Grid = ({ columns, data, Cell }) => {
  if (
    ...
    throw new Error(
      `Columns must be either 1, 2, 3, 4, 6 or 12 but was instead ${columns}`,
    )
  }
  ...
  return <div className="container examples">{elements}</div>
}
