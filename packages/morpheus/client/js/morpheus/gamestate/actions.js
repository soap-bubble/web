...
export function handlePanoHotspot({ hotspot, currentPosition, startingPosition, context, isMouseDown }) {
  return async (dispatch, getState) => {
    if (hotspot.param1 !== 0
    ...
    return await dispatch(handleHotspot({ hotspot, currentPosition, startingPosition, isMouseDown, context }));
  };
}
